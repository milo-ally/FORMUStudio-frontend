...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=ai3d&Version=2025-05-13&Action=DescribeProfileTo3DJob" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1804/120832)，本接口取值：DescribeProfileTo3DJob。 |
...
| JobId | 否 | String | 任务ID。<br/>示例值：1315932989749215232 |
...
| ErrorCode | String | 错误码<br/>示例值：InvalidParameter|
| ErrorMessage | String | 错误信息<br/>示例值：参数错误|
| ResultFile3Ds | Array of [File3D](/document/api/1804/120828#File3D) | 生成的3D文件数组。<br/>示例值：File3D数据结构|
...
X-TC-Action: DescribeProfileTo3DJob
<公共请求参数>
